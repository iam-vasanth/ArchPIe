...
collect_shell_config_choice() {
    echo ""
    echo -e "${BLUE}=== Shell Configuration Setup ===${NC}"
    read -p "Do you want to setup shell config (OhmyZSH, tmux & starship)? (y/n): " SETUP_SHELL
...
# Install and configure ghostty, ohmyzsh, tmux and starship
